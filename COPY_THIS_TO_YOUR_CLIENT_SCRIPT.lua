--[[
    ...
    INSTALLATION:
    1. Open your LocalScript in StarterPlayerScripts (the one named "eggvfxstarterplayer")
    2. DELETE everything in it
    3. PASTE this entire code
    4. Done!
    
    This has _G.TriggerVFX() AND _G.TestEggReveal()!
]]
...
print("🔥 UNIFIED VFX CLIENT - Loading...")

-- ============================================================================
-- EGG REVEAL SYSTEM (tries to load, gracefully fails if missing)
-- ============================================================================
...
local function loadEggRevealSystem()
	...
	if not success then
		warn("⚠️ Egg Reveal System not available (missing modules) - Only Screen VFX will work")
...
-- ============================================================================
-- SCREEN VFX SYSTEM (always available!)
-- ============================================================================
...
-- ============================================================================
-- GLOBAL TEST FUNCTIONS (THIS IS IMPORTANT!)
-- ============================================================================

-- Test Egg Reveal
_G.TestEggReveal = function(rarity, petName)
	if not eggRevealLoaded then
		warn("❌ Egg Reveal not available - missing modules or EggModel")
		warn("   Try _G.TriggerVFX('Epic') instead for Screen VFX!")
		return
	end
...
_G.TriggerVFX = function(rarity)
	rarity = rarity or "Epic"
	print("🎮 Calling TriggerVFX with rarity:", rarity)
	screenVfxSystem:TriggerVFX(rarity)
end
...
if eggRevealLoaded then
	...
	print("   ⚠️  Egg Reveal System (not available - missing modules)")
end
print("   ✅ Screen VFX System (no camera)")
print("      Test: _G.TriggerVFX('Epic')")
print("💡 Press E near interactive parts!")
print("")
print("🔥 _G.TriggerVFX is now available! Try: _G.TriggerVFX('Epic')")
